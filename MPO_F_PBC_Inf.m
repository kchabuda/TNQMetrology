function [result,a0,c] = MPO_F_PBC_Inf(figureofmerit,d,bdpsi,bdl,noiserange,integral0,integral1,integral2,lherm,phi,imprecision,a0,c)
% Parameters
...
while 1
    ...
    for nx = 1:d
        for nxp = 1:d
            ...
            b(:,:,nx,nxp) = (1-1i*(nx-nxp)*phi)*a(:,:,nx,nxp);
        end
    end
